...
btnMyProfiele = findViewById(R.id.button_my_profile);
btnAboutALC = findViewById(R.id.button_about_ALC);
btnMyProfiele.setOnClickListener(new View.OnClickListener() {
    @Override
